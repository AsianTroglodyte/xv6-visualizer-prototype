...
def main() -> int:
  parser = argparse.ArgumentParser(description="Render xv6 physical memory as a live line")
  parser.add_argument("--output", default="memline.svg", help="output SVG path")
